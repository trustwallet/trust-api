 ...
 *  curl -i https://trust-api.herokuapp.com/ethereum/transactions?address=0x1a007089523cc763d8e7c8a2f33429b28cdae5d5
 *
 ...
 *
 * @apiExample {curl} Example usage
 *  curl -i https://trust-api.herokuapp.com/tokens/list?query=TRX&networks=60
 *
 * @apiSuccessExample {json} Sucess-Response:
 *      HTTPS  200 OK
 * {
 ...
 *
 * @apiExample {curl} Example usage
 *  curl -i http://localhost:8003/assets?address=0xe47494379c1d48ee73454c251a6395fdd4f9eb43
 *
 * @apiSuccessExample {json} Sucess-Response:
 *      HTTPS  200 OK
 * {
